(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slide__swiper")) new swiper_core_Swiper(".slide__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".about-slide__swiper")) new swiper_core_Swiper(".about-slide__swiper", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".news__swiper")) new swiper_core_Swiper(".news__swiper", {
            modules: [ Navigation ],
            spaceBetween: 32,
            loop: true,
            navigation: {
    ...
    const videoContainer = document.querySelector(".banner__video-box");
    ...
    function init() {
        const mapOptions = {
            zoom: 15,
            center: new google.maps.LatLng(46.421433, 30.7220767, 15.35),
            styles: [ {
                featureType: "all",
        ...
        new google.maps.Marker({
            position: new google.maps.LatLng(46.4230582, 30.7245971, 18.07),
            map,
            title: "Snazzy!"
        });
    }
